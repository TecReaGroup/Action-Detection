...
ONE_EURO_BETA = 0.05
ONE_EURO_DERIVATIVE_CUTOFF = 2.0
ONE_EURO_RESET_SECONDS = 0.5
HAND_JOINT_COUNT = 21
with CONFIG_PATH.open("rb") as stream:
...
POSE_FEATURE_VERSION = (
    f"rtmw-hand-confidence-partial-{HAND_SELECTION}-kpt{KEYPOINT_THRESHOLD}-v8"
    f"-euro{ONE_EURO_MIN_CUTOFF}-{ONE_EURO_BETA}-{ONE_EURO_DERIVATIVE_CUTOFF}"
    f"-reset{ONE_EURO_RESET_SECONDS}"
)
LEFT_HAND_START = 91
